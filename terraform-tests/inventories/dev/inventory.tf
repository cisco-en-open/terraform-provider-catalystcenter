# Development Inventory Configuration
# This file defines the Terraform configuration for the development environment
...
# Configure provider with development environment settings
